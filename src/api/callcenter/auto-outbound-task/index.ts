...
export const updateAutoOutboundTask = (id: string | number, data: AutoOutboundTaskForm) =>
  request({ url: `${root}/${id}`, method: 'put', data });
...
export const listAutoOutboundSources = (id: string | number) =>
  request<AutoOutboundSourceVO[]>({ url: `${root}/${id}/sources`, method: 'get' });
...
export const getAutoOutboundMonitor = (id: string | number) =>
  request<AutoOutboundMonitorVO>({ url: `${root}/${id}/monitor`, method: 'get' });
export const runAutoOutboundScheduler = () =>
  request<AutoOutboundSchedulerResultVO>({ url: `${root}/scheduler/run`, method: 'post' });
